...
export const metadata: Metadata = {
  ...
  title: {
    default: "DialLock AI – AI-Powered Sales Assistant",
    template: "%s | DialLock AI",
  },
  description:
    "Supercharge your sales outreach with DialLock AI – an intelligent B2B outbound automation agent for faster conversions.",
  keywords: [
    "AI Sales Assistant",
    "B2B Lead Generation",
        ...
        >
          ...
          <div className="relative max-w-7xl mx-auto grid md:grid-cols-4 gap-10">
            ...
            <div>
              ...
              <p className="text-gray-700 leading-relaxed text-sm">
                Explore our features, services, and marketing content. Connect with us on
                socials for updates.
              </p>
              <a
                ...
                aria-label="LinkedIn"
                className="inline-block mt-6 text-blue-500 hover:text-blue-400 transition"
              >
                <svg
                  className="w-8 h-8"
                  fill="currentColor"
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-700 text-sm">
                {[
                  "Diallock-ai DeepAgent",
                  "Diallock-ai Growth",
                  "Diallock-ai HyperReach",
                  "Diallock-ai Forms",
                  "Diallock-ai Testimonials",
                  "Diallock-ai Optinly",
                  "Diallock-ai Content.Ai",
                  "Diallock-ai Engage",
                  "Diallock-ai Notify",
                ].map((item) => (
                  <li
          ...
          <div className="relative z-20 max-w-7xl mx-auto mt-12 pt-6 border-t border-gray-700 flex flex-col items-center text-center space-y-2">
            <p className="text-xs text-gray-900 font-medium">
              © {new Date().getFullYear()} DialLock AI. Made with ❤️ from India to{" "}
              <a
